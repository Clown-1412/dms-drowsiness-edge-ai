...
from src.utils.landmark_drawing import draw_mouth_landmarks
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Demo rieng cho mouth_landmarks")
    ...
    try:
        ...
        while True:
            ...
            if detection["face_detected"]:
                ...
                print(
                    "face_detected=True | "
                    f"mouth_landmarks={len(detection['mouth_landmarks'])}"
                )
            else:
            ...
            cv2.imshow("DMS Mouth Landmarks Demo", display_frame)
